...
export const srLatn: Record<keyof typeof en, string> = {
  ...
  'profile.intro': 'Vaše ime, podaci za prijavu i uređaji koji su prijavljeni.',
  'profile.loading': 'Učitavanje profila…',
  'profile.toSettings': 'Nazad na podešavanja',
  'profile.open': 'Otvori profil',
  'profile.identity.title': 'Vaši podaci',
  ...
  'profile.email.passwordLabel': 'Vaša lozinka',
  'profile.email.change': 'Pošalji link za potvrdu',
  'profile.email.changeSent': 'Link za potvrdu je poslat na {email}. Dok ga ne otvorite, prijavljujete se sa trenutnom adresom.',
  'profile.email.hint': 'Link šaljemo na novu adresu. Ništa se ne menja dok ga ne otvorite.',
  ...
  'profile.sessions.title': 'Gde ste prijavljeni',
  'profile.sessions.intro': 'Ove sesije trenutno mogu da pristupe vašem nalogu. Podaci o uređaju se ne čuvaju, pa se prikazuju samo vremena.',
  ...
  'profile.language.intro': 'Jezik aplikacije i poruka koje vam šaljemo.',
  ...
  'verify.changeDone': 'Nova adresa je sada adresa sa kojom se prijavljujete.',
