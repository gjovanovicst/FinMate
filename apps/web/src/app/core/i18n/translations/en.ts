...
export const en = {
  ...
  'profile.displayName.saved': 'Saved.',
  'profile.email.label': 'Email address',
  'profile.email.verified': 'Confirmed',
  'profile.email.unverified': 'Not confirmed',
  'profile.email.pending': 'Waiting for confirmation: {email}',
  'profile.email.newLabel': 'New email address',
  'profile.email.passwordLabel': 'Your password',
  'profile.email.change': 'Send confirmation link',
  'profile.email.changeSent': 'A confirmation link is on its way to {email}. Until you open it, your current address stays the one you sign in with.',
  'profile.email.hint': 'We send the link to the new address. Nothing changes until you open it.',
  'profile.password.title': 'Password',
  'profile.password.current': 'Current password',
  'profile.password.new': 'New password',
  'profile.password.change': 'Change password',
  'profile.password.changed': 'Password changed. Other devices have been signed out.',
  'profile.password.hint': 'At least {min} characters. Every other device is signed out.',
  'profile.sessions.title': 'Where you are signed in',
  'profile.sessions.intro': 'These sessions can currently reach your account. Device details are not stored, so only times are shown.',
  'profile.sessions.current': 'This device',
  'profile.sessions.other': 'Another device',
  'profile.sessions.started': 'Started {when}',
  'profile.sessions.lastSeen': 'Last used {when}',
  ...
  'mfa.status.emailOn': 'Emailed code: on',
  'mfa.status.emailOff': 'Emailed code: off',
  'mfa.status.codes': '{count} recovery codes left',
  'mfa.app.setup': 'Set up an authenticator app',
  'mfa.app.unavailable': 'Authenticator apps are not configured on this deployment. The emailed code still works.',
  'mfa.app.disable': 'Turn off the authenticator app',
  'mfa.app.disabled': 'The authenticator app is off.',
  'mfa.app.enabled': 'Two-step verification is on. Save your recovery codes.',
  'mfa.app.scan': 'Scan this with your authenticator app.',
  'mfa.app.manual': 'Or type this key into the app by hand:',
  'mfa.app.codeLabel': 'Code from the app',
  'mfa.app.confirm': 'Turn on',
  'mfa.email.enable': 'Email me a code',
  'mfa.email.disable': 'Stop emailing me a code',
  'mfa.email.enabled': 'The emailed code is on.',
  'mfa.email.disabled': 'The emailed code is off.',
  'mfa.codes.regenerate': 'New recovery codes',
  'mfa.codes.regenerated': 'New recovery codes. The old ones no longer work.',
  'mfa.codes.intro': 'Save these somewhere safe. Each works once, and they are the way in if you lose your authenticator. They are shown only this once.',
  'mfa.codes.saved': 'I have saved them',
  'mfa.qrAlt': 'QR code for setting up the authenticator app',
  // The second step of signing in.
  'signIn.mfaTitle': 'Two-step verification',
  'signIn.mfaIntroApp': 'Enter the code from your authenticator app.',
  'signIn.mfaIntroEmail': 'We emailed a code to {email}.',
  'signIn.mfaCode': 'Code',
  'signIn.mfaVerify': 'Verify',
  'signIn.mfaVerifying': 'Checking the code…',
  'signIn.mfaRecoveryHint': 'You can also enter one of your recovery codes.',
  'signIn.mfaResend': 'Email me a code',
  'signIn.mfaResending': 'Sending…',
  'signIn.mfaResendSent': 'A new code is on its way.',
  'signIn.mfaBack': 'Use a different account',
  ...
  'error.MFA_INVALID_CODE': 'That code is not correct.',
