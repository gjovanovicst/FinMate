...
| 4.3.2 | Install prompt / Add-to-Home-Screen flow. **Unblocked 2026-09-17**: the name is decided (`FinMate`, ADR-014's amendment), so the manifest, icons and install prompt may carry it — the screening that decision skipped is **R-28** | 1 | F-26 |
