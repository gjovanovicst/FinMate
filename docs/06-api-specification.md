...
| `notificationReceived` subscription | **Not built** | It needs a pub/sub transport the API does not have (docs/06 §6). The badge polls, as the review-queue badge already does. |
