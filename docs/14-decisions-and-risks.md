...
- ⚠️ The queue's own refusal is unchanged and still real — an offline composer has no account to attach
  (R-27(a2), which ADR-025 decision 5's *"the categories and accounts the composer needs"* already
  requires and nothing writes yet).
