...
| Tests | **1451 pass** — 492 API + 141 domain + 303 web + 149 nlp + 108 rules-engine + 258 ai (+contracts) |
...
Verified working: lint 9/9, typecheck 9/9, 1451 tests, `web:build`, GraphQL over HTTP through the
...
| **debugging something that should work** | **[`docs/15-implementation-gotchas.md`](docs/15-implementation-gotchas.md)** — 69 entries, each saying what the failure looks like |
...
**The full list — 69 entries in 10 groups, each written to say what it looks like when it goes wrong —
