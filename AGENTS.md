...
| Tests | **2119 pass** — 869 API + 272 domain + 457 web + 149 nlp + 108 rules-engine + 258 ai + 6 worker (+contracts) |
...
Verified working: lint 9/9, typecheck 9/9, 2119 tests, `pnpm test:evals` gating green, `web:build`, GraphQL over HTTP through the
