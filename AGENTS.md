...
| **debugging something that should work** | **[`docs/15-implementation-gotchas.md`](docs/15-implementation-gotchas.md)** — 210 entries, each saying what the failure looks like |
...
**The full list — 210 entries in 10 groups, each written to say what it looks like when it goes wrong —
