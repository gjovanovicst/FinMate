...
| Tests | **2077 pass** — 854 API + 264 domain + 438 web + 149 nlp + 108 rules-engine + 258 ai + 6 worker (+contracts) |
...
Verified working: lint 9/9, typecheck 9/9, 2077 tests, `pnpm test:evals` gating green, `web:build`, GraphQL over HTTP through the
...
| **debugging something that should work** | **[`docs/15-implementation-gotchas.md`](docs/15-implementation-gotchas.md)** — 94 entries, each saying what the failure looks like |
...
**The full list — 94 entries in 10 groups, each written to say what it looks like when it goes wrong —
