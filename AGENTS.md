...
| Tests | **2097 pass** — 855 API + 264 domain + 457 web + 149 nlp + 108 rules-engine + 258 ai + 6 worker (+contracts) |
...
Verified working: lint 9/9, typecheck 9/9, 2097 tests, `pnpm test:evals` gating green, `web:build`, GraphQL over HTTP through the
...
| **debugging something that should work** | **[`docs/15-implementation-gotchas.md`](docs/15-implementation-gotchas.md)** — 96 entries, each saying what the failure looks like |
...
**The full list — 96 entries in 10 groups, each written to say what it looks like when it goes wrong —
