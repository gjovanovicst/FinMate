...
| Tests | **2899 pass** — **1162** API + 279 ai + 272 domain + **920** web + 152 nlp + 108 rules-engine + 6 worker (plus `contracts`, which ships no specs and passes with none) |
...
Verified working: lint 9/9, typecheck 9/9, 2899 tests, `pnpm test:evals` gating green, `web:build`, GraphQL over HTTP through the
