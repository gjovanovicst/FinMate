...
| Tests | **673 pass** — 263 API + 114 domain + 105 web + 83 nlp + 108 rules-engine |
...
Verified working: lint 9/9, typecheck 9/9, 673 tests, `web:build`, GraphQL over HTTP through the
