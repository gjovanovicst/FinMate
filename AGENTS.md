...
| Tests | **959 pass** — 263 API + 114 domain + 105 web + 149 nlp + 108 rules-engine + 220 ai |
...
Verified working: lint 9/9, typecheck 9/9, 959 tests, `web:build`, GraphQL over HTTP through the
