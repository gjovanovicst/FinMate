...
| Tests | **2693 pass** — **1010** API + 275 ai + 272 domain + **873** web + 149 nlp + 108 rules-engine + 6 worker (plus `contracts`, which ships no specs and passes with none) |
...
Verified working: lint 9/9, typecheck 9/9, 2693 tests, `pnpm test:evals` gating green, `web:build`, GraphQL over HTTP through the
