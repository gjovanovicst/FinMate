...
| Tests | **1509 pass** — 528 API + 163 domain + 303 web + 149 nlp + 108 rules-engine + 258 ai (+contracts) |
...
Verified working: lint 9/9, typecheck 9/9, 1509 tests, `pnpm test:evals` gating green, `web:build`, GraphQL over HTTP through the
