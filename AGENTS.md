...
- **4.3.1d measured every screen instead of assuming, and it paid twice.** A browser instrument walked all
  ...
  (two inactive controls are **exempt**, WCAG 1.4.3). It also
...
- **Next**: **4.3.2** — the manifest, icons and install prompt, unblocked by the name decision; then the
  **human visual pass** (the 4.3.1d contact sheet → **4.3.1e**'s 17 controls under 24 px, **4.3.1c**'s
  pinned capture bar, the nested-`<main>` landmarks), 4.3.3 (mobile keyboard) and 4.3.4b's Lighthouse job.
